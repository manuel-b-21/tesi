\chapter{Chaos analysis in the electronic Burridge-Knopoff model}\label{chap: chaos analysis}
...
\begin{figure}[ht!]
    \centering
    \subfloat{\includegraphics[width=0.494\linewidth]{../blocks/3_blocks/edge/attractor.pdf}}
    \subfloat{\includegraphics[width=0.494\linewidth]{../blocks/3_blocks/middle/attractor.pdf}}
...
This means that in this case the amplitudes are smaller, resulting in a higher ratio between the
quantization noise and the amplitude of the signal. In other words, the number of distinct values of
the oscilloscope is smaller. This implies higher estimates of the correlation dimension.
