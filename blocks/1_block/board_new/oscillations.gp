set term pdf
set output "single_block_integrated.pdf"
...
#set format y "%.1f"
set ytics 0,1,3
plot "board_wf_avg_avg.dat" u 1:3 w l notitle lc "blue" lw 0.5
...
plot "board_wf_avg_avg.dat" u 1:2 w l notitle lc "blue" lw 0.5
...
set xtics -2,1,2
set ytics 0,1,3
plot "board_wf_avg_avg.dat" u 2:3 w l notitle lc "blue" lw 0.5
