...
\ref{fig:breadboard implementation}. The chaotic behavior of
the two blocks is shown in Fig. \ref{fig:2 blocks waveforms}.
...
\begin{figure}[H]
    ...
    \begin{minipage}{.49\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth,trim={2cm 0 2cm 0},clip]
            {../2_blocks/plots/lissajous_1.png}\\
            \includegraphics[width=\linewidth]
            {../2_blocks/plots/waveforms_1.png}
        \end{subfigure}
    \end{minipage}
    \begin{minipage}{.49\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth,trim={2cm 0 2cm 0},clip]
            {../2_blocks/plots/lissajous_2.png}\\
            \includegraphics[width=\linewidth]
            {../2_blocks/plots/waveforms_2.png}
        \end{subfigure}
    \end{minipage}
    \caption{Chaotic behavior of two coupled blocks for
    $V_d=0.05$ V and for 100 ms.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{.49\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth]
            {../2_blocks/plots/heatmap.pdf}\\
            \includegraphics[width=\linewidth]
            {../2_blocks/plots/histogram.pdf}
        \end{subfigure}
    \end{minipage}
    \begin{minipage}{.49\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth]
            {../2_blocks/plots/joint.pdf}\\
            \includegraphics[width=\linewidth]
            {../2_blocks/plots/mle.pdf}
        \end{subfigure}
    \end{minipage}
    \caption{Ciao.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{.49\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth]
            {../3_blocks/4e4_points/plots/heatmap.pdf}\\
            \includegraphics[width=\linewidth]
            {../3_blocks/4e4_points/plots/histogram.pdf}
        \end{subfigure}
    \end{minipage}
    \begin{minipage}{.49\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth]
            {../3_blocks/4e4_points/plots/joint.pdf}\\
            \includegraphics[width=\linewidth]
            {../3_blocks/4e4_points/plots/mle.pdf}
        \end{subfigure}
    \end{minipage}
    \caption{Ciao.}
