...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../7_blocks/plots/chaos_low.pdf}
    \caption{ciao}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../8_blocks/plots/chaos_low.pdf}
    \caption{ciao}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../9_blocks/plots/chaos_low.pdf}
    \caption{ciao}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{../10_blocks/plots/chaos_low.pdf}
    \caption{ciao}
