...
\begin{figure}[H]
    \centering
    \subfloat{\includegraphics[width=0.43\linewidth]{images/BK1.png}}\\[0.43cm]
    \subfloat{\includegraphics[width=0.43\linewidth]{images/BK2.png}}
...
The blocks are thus driven by the relative movement of the two rigid plates. When the force on one block
