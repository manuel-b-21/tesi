\chapter{Chaos in theory and experiments}\label{chap: chaos}
...
Appropriate embedding choices should meet two requirements regarding the corresponding embedding window $w=(m-1)LT$, which corresponds to the
