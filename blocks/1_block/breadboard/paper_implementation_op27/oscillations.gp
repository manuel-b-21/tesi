...
#set format y "%.1f"
set ytics 0,1,3
plot "bread_wf_avg_avg.dat" u 1:3 w l notitle lc "blue" lw 0.5
...
plot "bread_wf_avg_avg.dat" u 1:2 w l notitle lc "blue" lw 0.5
...
set xtics -2,1,2
set ytics 0,1,3
plot "bread_wf_avg_avg.dat" u 2:3 w l notitle lc "blue" lw 0.5
...
set format x2 ""
set xtics 0,0.5,3
plot "measurements.txt" u 1:3 w l notitle lc "dark-blue" lw 0.5
replot "measurements.txt" u 1:3 w p lc "dark-blue" ps 0.2 pt 5 notitle
...
set format x2 ""
set xtics 0,0.5,3
plot "measurements.txt" u 1:2 w l notitle lc "dark-blue" lw 0.5
replot "measurements.txt" u 1:2 w p lc "dark-blue" ps 0.2 pt 5 notitle
