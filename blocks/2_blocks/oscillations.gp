set term pdf
set output "two_blocks_nochaos.pdf"
...
#set format y "%.1f"
set ytics 0,1,3
plot "2_blocks_avg_05V.dat" u 1:2 w l notitle lc "blue" lw 0.5
...
plot "2_blocks_avg_05V.dat" u 1:3 w l notitle lc "blue" lw 0.5
...
set xtics -2,1,2
set ytics 0,1,3
plot "2_blocks_avg_05V.dat" u 3:2 w l notitle lc "blue" lw 0.5