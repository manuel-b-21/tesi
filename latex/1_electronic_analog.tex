...
\begin{figure}[H]
    ...
    {../blocks/1_block/prototypes/prototype_implementation.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{.58\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth,trim={0 6cm 0 6cm},clip,left]
            {../blocks/1_block/board/W_wf.pdf}\\
            \includegraphics[width=\linewidth,trim={0 6cm 0 6cm},clip,left]
            {../blocks/1_block/board/V_wf.pdf}
        \end{subfigure}
    \end{minipage}
    \begin{subfigure}{.39\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={15cm 0 15cm 0},clip,right]
        {../blocks/1_block/board/Lissajous.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\linewidth,trim={10cm 0 9cm 0},clip,left]
        {../blocks/1_block/board/freq_board.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={9cm 0 10cm 0},clip,right]
        {../blocks/1_block/board/rms_board.pdf}
    \end{subfigure}
    \caption{Oscillating behavior for the circuit implemented on
...
\begin{figure}[H]
    ...
    \begin{minipage}{.58\textwidth}
        \begin{subfigure}{\linewidth}
            \centering
            \includegraphics[width=\linewidth,trim={0 6cm 0 6cm},clip,left]
            {../blocks/1_block/board_new/W_wf.pdf}\\
            \includegraphics[width=\linewidth,trim={0 6cm 0 6cm},clip,left]
            {../blocks/1_block/board_new/V_wf.pdf}
        \end{subfigure}
    \end{minipage}
    \begin{subfigure}{.39\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={15cm 0 15cm 0},clip,right]
        {../blocks/1_block/board_new/Lissajous.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\linewidth,trim={10cm 0 9cm 0},clip,left]
        {../blocks/1_block/board_new/freq_board.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={9cm 0 10cm 0},clip,right]
        {../blocks/1_block/board_new/rms_board.pdf}
    \end{subfigure}
    \caption{Oscillating behavior for the circuit implemented on
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\linewidth,trim={10cm 0 9cm 0},clip,left]
        {../blocks/1_block/images/freq_comparison.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={9cm 0 10cm 0},clip,right]
        {../blocks/1_block/images/rms_comparison.pdf}
    \end{subfigure}
