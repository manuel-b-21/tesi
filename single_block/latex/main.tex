...
\title{\bf{Measurements on single Burridge-Knopoff oscillator}}
\author{Bitto Manuel}
\date{\today}
\maketitle
...
\begin{figure}[H]
    ...
    {../breadboard/breadboard_implementation.png}
...
\begin{figure}[H]
    ...
    {../prototypes/prototype_implementation.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.39\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={15cm 0 15cm 0},clip,right]
        {../prototypes/Lissajous.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\linewidth,trim={10cm 0 9cm 0},clip,left]
        {../prototypes/freq_prot.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={9cm 0 10cm 0},clip,right]
        {../prototypes/rms_prot.pdf}
    \end{subfigure}
    \caption{Oscillating behavior for the circuit implemented on
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.39\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={15cm 0 15cm 0},clip,right]
        {../board_new/Lissajous.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\linewidth,trim={10cm 0 9cm 0},clip,left]
        {../board_new/freq_board.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={9cm 0 10cm 0},clip,right]
        {../board_new/rms_board.pdf}
    \end{subfigure}
    \caption{Oscillating behavior for the circuit implemented on
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\linewidth,trim={10cm 0 9cm 0},clip,left]
        {../images/freq_comparison.pdf}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={9cm 0 10cm 0},clip,right]
        {../images/rms_comparison.pdf}
    \end{subfigure}
    \caption{(a) Frequency and (b) root mean squareamplitude
