...
set label at graph -0.235,1.05 "{/:Bold a}" font ",10"
set xlabel "m"
set ylabel "L"
set tmargin 0
set bmargin 0
...
unset label
set label at graph -0.235,1.05 "{/:Bold c}" font ",10"
set ytics auto
set yrange [0:30]
set xrange [1:6]
set xlabel "{/Symbol n}"
...
unset label
set label at graph -0.14,1.05 "{/:Bold b}" font ",10"
set errorbars 0.5
...
set label at graph 0.55,0.3 "n_{blocks}=5  (center)" font ",10" front
...
unset label
set label at graph -0.14,1.05 "{/:Bold d}" font ",10"
set bars small
set xlabel "w = (m-1)LT (ms)"
set ylabel "MLE (kHz)" off -0.75,0
set tmargin 0
set bmargin 0
set size 0.48,0.3
set origin 0.4835,0.125
set xrange [1*T:250*T]
set yrange [0:5]
f(x) = mle_mean
fit [*:*][500:3000] f(x) "mle.dat" using (($1-1)*$2*T) : \
